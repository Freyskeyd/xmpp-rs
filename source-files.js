...
sourcesIndex["xmpp_server"] = {"name":"","dirs":[{"name":"listeners","dirs":[{"name":"tcp","files":["listener.rs","session.rs"]}],"files":["tcp.rs","ws.rs"]},{"name":"messages","files":["system.rs","tcp.rs"]},{"name":"parser","files":["codec.rs","sink.rs"]},{"name":"sessions","files":["manager.rs","state.rs","unauthenticated.rs"]}],"files":["authentication.rs","config.rs","lib.rs","listeners.rs","messages.rs","packet.rs","parser.rs","router.rs","sessions.rs"]};
