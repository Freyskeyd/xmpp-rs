...
pub struct OpenStream {
    ...
    #[builder(setter(into), default = "String::from(\"en\")")]
    pub lang: String,
...
impl ToXmlElement for OpenStream {
    ...
    fn to_element(&self) -> Result<Element, Self::Error> {
        ...
        element
            .set_tag(&qname_stream)
            .set_attr("version", self.version.to_string())
            .set_attr((ns::XML_URI, "lang"), self.lang.to_string())
            .set_attr("id", self.id.clone().unwrap_or_else(|| Uuid::new_v4().to_string()));
